...
export const VIEW_H = MARGIN_TOP + PLOT_H + MARGIN_BOTTOM; // 286
...
// Title text sits this far above the top margin.
export const TITLE_DY = 10;
...
// Colors. (Phase 2 promotes these into the design-token system.)
export const CHART_COLORS = {
  accent: "#6366f1", // bars, line, dots
  baseline: "#e5e7eb", // axis baseline
  gridFaint: "#f3f4f6", // y reference lines
  titleText: "#374151",
  valueText: "#6b7280",
  mutedText: "#9ca3af", // category + axis labels
} as const;
